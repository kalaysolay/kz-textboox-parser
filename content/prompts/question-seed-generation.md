...
Иллюстрации: в v1 их НЕТ. В банке вопросов Damulab негде хранить картинку, маркер {{IMG:…}} просто
отобразится ученику как текст. Поэтому у ВСЕХ вопросов needsIllustration=false, illustration=null,
никаких маркеров в body, illustrationPolicy="none". Не добавляй рисунки «для красоты»: чистый
текст и арифметика (деление на 10/100/1000, проценты от числа, порядок действий) в них не нуждаются.
